#+title: i3 Config
#+property: header-args :tangle ~/.dotfiles/home/.config/i3/config
...
# feh (wallpaper)
exec --no-startup-id feh --no-fehbg --bg-fill /usr/share/backgrounds/rushing-currents.jpg
...
# ensure workspaces exist so they always show in the bar
exec --no-startup-id i3-msg 'workspace $ws1; workspace $ws2; workspace $ws3; workspace $ws4; workspace $ws5; workspace $ws1'
